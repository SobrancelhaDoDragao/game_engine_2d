...
class PysicsEngine2D:
    ...
    def create_flipper(self):
        pos = (self.map.flippers_position[1][0] - 20,self.map.flippers_position[1][1]+5)
    ...
    def create_flipper_left(self):
        pos = (self.map.flippers_position[0][0] + 20,self.map.flippers_position[0][1]+5)
    ...
    def botao(self):
        self.r_flipper_body.apply_impulse_at_local_point(Vec2d.unit() * -50000, (-150,0))

    def botaoleft(self):
        self.l_flipper_body.apply_impulse_at_local_point(Vec2d.unit() * 50000, (-150, 0))
